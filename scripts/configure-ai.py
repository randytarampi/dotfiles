#!/usr/bin/env python3
"""
configure-ai.py — Resolves machine-specific paths and secrets for AI tool configurations.
...
def main():
    ...
    for target_dir in target_dirs:
        ...
        env_content = f"""# Generated by configure-ai.py
...
"""
    ...
    if args.configure_jetbrains_ai:
        ...
        try:
            subprocess.run([sys.executable, configure_jb_py, "--all"])
